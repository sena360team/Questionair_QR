-- ============================================
-- Migration: Fix QR Code Schema (Add missing columns)
-- ============================================
...
-- 3. สร้าง function สำหรับบันทึกการ scan QR Code (ถ้ายังไม่มี หรือ replace ไปเลย)
