...
export default function SubmissionsListPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Forms List - Full Width Table */}
      {loading ? (
        <div className="flex items-center justify-center py-20">
          <div className="animate-spin w-8 h-8 border-4 border-blue-600 border-t-transparent rounded-full" />
        </div>
      ) : forms.length === 0 ? (
        <div className="text-center py-16 bg-white rounded-2xl border-2 border-slate-300">
            ...
            <table className="w-full min-w-[700px]">
              <thead className="bg-slate-50 border-b border-slate-300">
                <tr>
                  ...
                  <th className="px-6 py-4 text-center text-sm font-semibold text-slate-700 w-28">Version</th>
                  <th className="px-6 py-4 text-center text-sm font-semibold text-slate-700 w-32">คำตอบ</th>
                  <th className="px-6 py-4 text-center text-sm font-semibold text-slate-700 w-32">สถานะ</th>
                  <th className="px-6 py-4 text-center text-sm font-semibold text-slate-700 w-32"></th>
                </tr>
              </thead>
